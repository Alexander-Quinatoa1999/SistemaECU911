<%@ Page Title="" Language="C#" MasterPageFile="~/views/Doctores/Medico.Master" AutoEventWireup="true" CodeBehind="RegistrosEvolucion.aspx.cs" Inherits="SistemaECU911.views.Doctores.RegistrosEvolucion" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    Pacientes HCL Evolución | Sistema Médico
</asp:Content>
                                    ...
                                    <asp:GridView ID="grvPacientesEvolucion" OnRowCommand="grvPacientesEvolucion_RowCommand" AutoGenerateColumns="false" Width="100%" CssClass="table table-hover text-center table-responsive" GridLines="None" runat="server" Style="margin-right: 0px">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="FECHA MODIFICACION">
                                                <ItemTemplate>
                                                    <asp:Label ID="evo_fecha_hora" runat="server" Text='<%#Eval("evo_fecha_horaModificacion")%>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField ItemStyle-Width="17" HeaderStyle-Width="17" HeaderText="">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lnbEditar" Width="16" Height="16" CommandArgument='<%#Eval("evo_id")%>' CommandName="Editar" runat="server"><i class="fas fa-pen"></i></asp:LinkButton>
                                                </ItemTemplate>
