<%@ Page Title="" Language="C#" MasterPageFile="~/views/Doctores/Medico.Master" AutoEventWireup="true" CodeBehind="RegistrosRetiro.aspx.cs" Inherits="SistemaECU911.views.Doctores.RegistrosRetiro" %>
                                    ...
                                    <asp:GridView ID="grvPacientesRetiro" OnRowCommand="grvPacientesRetiro_RowCommand" AutoGenerateColumns="false" Width="100%" CssClass="table table-hover text-center table-responsive" GridLines="None" runat="server" Style="margin-right: 0px">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="FECHA GUARDADO">
                                                <ItemTemplate>
                                                    <asp:Label ID="ret_fechaHoraGuardado" runat="server" Text='<%#Eval("ret_fechaHoraGuardado")%>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="FECHA MODIFICACION">
                                                <ItemTemplate>
                                                    <asp:Label ID="ret_fecha_hora" runat="server" Text='<%#Eval("ret_fecha_horaModificacion")%>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
