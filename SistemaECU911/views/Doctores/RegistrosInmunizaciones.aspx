<%@ Page Title="" Language="C#" MasterPageFile="~/views/Doctores/Medico.Master" AutoEventWireup="true" CodeBehind="RegistrosInmunizaciones.aspx.cs" Inherits="SistemaECU911.views.Doctores.RegistrosInmunizaciones" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    Pacientes HCL Inmunizaciones | Sistema Médico
</asp:Content>
                                    ...
                                    <asp:GridView ID="grvPacientesInmunizaciones" OnRowCommand="grvPacientesInmunizaciones_RowCommand" AutoGenerateColumns="false" Width="100%" CssClass="table table-hover text-center table-responsive" GridLines="None" runat="server" Style="margin-right: 0px">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="FECHA GUARDADO">
                                                <ItemTemplate>
                                                    <asp:Label ID="inmu_fechaHoraGuardado" runat="server" Text='<%#Eval("inmu_fechaHoraGuardado")%>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="FECHA MODIFICACION">
                                                <ItemTemplate>
                                                    <asp:Label ID="inmu_fecha_hora" runat="server" Text='<%#Eval("inmu_fecha_horaModificacion")%>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField ItemStyle-Width="17" HeaderStyle-Width="17" HeaderText="">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lnbEditar" Width="16" Height="16" CommandArgument='<%#Eval("inmu_id")%>' CommandName="Editar" runat="server"><i class="fas fa-pen"></i></asp:LinkButton>
                                                </ItemTemplate>
