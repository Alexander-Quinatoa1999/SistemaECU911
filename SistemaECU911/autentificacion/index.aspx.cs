...
namespace SistemaECU911.autentificacion
{
    public partial class index : System.Web.UI.Page
    {
        ...
        //private void logear()
        //{
        //    bool existenomMedico = CN_Usuarios.autentificarxNomMedico(txt_user.Text);
        //    bool existenomPaciente = CN_Usuarios.autentificarxNomPaciente(txt_user.Text);
        //    bool existenomTS = CN_Usuarios.autentificarxNomPersonaTS(txt_user.Text);
        //    bool existeMedico = CN_Usuarios.autentificarMedico(txt_user.Text, GetMD5(txt_pass.Text));
        //    bool existePaciente = CN_Usuarios.autentificarPaciente(txt_user.Text, GetMD5(txt_pass.Text));
        //    bool existeTS = CN_Usuarios.autentificarTS(txt_user.Text, GetMD5(txt_pass.Text));
        //    {
        ...
        //        else
        //        {
        //            if (existenomMedico || existenomPaciente || existenomTS)
        //            {
        //                if (existeMedico || existePaciente || existeTS)
        //                {
        //                    Tbl_Person person = new Tbl_Person();
        //                    Tbl_TipoUsuario tusu = new Tbl_TipoUsuario();

        //                    person = CN_Usuarios.autentificarxUsuPassMedico(txt_user.Text, GetMD5(txt_pass.Text));
