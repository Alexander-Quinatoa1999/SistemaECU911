                ...
                <div class="card card-responsive" style="width: auto;">
                    ...
                    <div class="list-group list-group-flush" style="padding: 10px; text-align: center">
                        ...
                        <div class="container" align="center">
                            <asp:Button CssClass="btn btn-success" ID="btn_guardar" runat="server" Text="Guardar" OnClick="btn_guardarsso_Click" UseSubmitBehavior="False" />
                            <asp:Button CssClass="btn btn-danger" ID="btn_cancelar" runat="server" Text="Cancelar" OnClick="btn_cancelarsso_Click" UseSubmitBehavior="False" />
                        </div>
                    </div>
                </div>
