        ...
        <ContentTemplate>
            <div class="container" style="background-color: white; font-family:Arial">
                    ...
                    <div class="list-group list-group-flush">
                        ...
                        <asp:Table class="table table-bordered table-light table-responsive text-center" runat="server">
                            <asp:TableRow>
                                ...
                                <asp:TableCell Text="FECHA DE INICIO DE LABORES" style="background-color: #cdfecc; font-size:15px"></asp:TableCell>
                                <asp:TableCell Text="FECHA DE SALIDA" style="background-color: #cdfecc; font-size:15px"></asp:TableCell>
                                <asp:TableCell Text="TIEMPO (meses)" style="background-color: #cdfecc; font-size:15px"></asp:TableCell>
                        ...
                        <asp:Table class="table table-bordered table-light table-responsive text-center" runat="server">
                            <asp:TableRow>
                                <asp:TableCell Text="ACTIVIDADES" Style="width: 600px; background-color: #cdfecc; font-size:15px"></asp:TableCell>
                                <asp:TableCell Text="FACTORES DE RIESGO" Style="width: 700px; background-color: #cdfecc; font-size:15px"></asp:TableCell>
                            </asp:TableRow>
                            <asp:TableRow>
                                <asp:TableCell>
                ...
                <div class="card" style="width: auto;">
                    ...
                    <asp:Table class="table table-bordered table-light table-responsive text-center" runat="server">
                        <asp:TableRow>
                            <asp:TableCell Style="width: 45%; background-color: white; font-size:14px">FUE CALIFICADO POR EL INSTITUTO DE SEGURIDAD SOCIAL CORRESPONDIENTE: </asp:TableCell>
                            <asp:TableCell style="background-color: white; font-size:14px">SI</asp:TableCell>
                            <asp:TableCell>
                            ...
                            <asp:TableCell style="background-color: white; font-size:14px">ESPECIFICAR</asp:TableCell>
                            ...
                            <asp:TableCell style="background-color: white; font-size:14px">NO</asp:TableCell>
                            <asp:TableCell>
                            ...
                            <asp:TableCell style="background-color: white; font-size:14px">FECHA:</asp:TableCell>
                            <asp:TableCell>
                        ...
                        <asp:TableRow>
                            <asp:TableCell ColumnSpan="9" Style="text-align: left; background-color:white">Detallar aquí en caso se presuma de algún accidente de trabajo que no haya sido reportado o calificado:</asp:TableCell>
                        </asp:TableRow>
                        <asp:TableRow>
                            <asp:TableCell ColumnSpan="9">
                ...
                <div class="card" style="width: auto;">
                    ...
                    <div class="list-group list-group-flush">
                        <asp:Table class="table table-bordered table-light text-center" runat="server">
                            <asp:TableRow>
                                <asp:TableCell Text="REGIONES" Style="width: 100%; text-align: left; background-color: #cdfecc; font-size:15px" ColumnSpan="15"></asp:TableCell>
                            </asp:TableRow>
                            <asp:TableRow>
                            ...
                            <asp:TableRow>
                                <asp:TableCell ColumnSpan="12" style="text-align: left; background-color: white; font-size: 13px">CON EVIDENCIA DE PATOLOGÍA MARCAR CON "X" Y DESCRIBIR EN LA SIGUIENTE SECCIÓN ANOTANDO EL NUMERAL</asp:TableCell>
