                ...
                <div class="card" style="width: auto;">
                    ...
                    <div class="list-group list-group-flush">
                        ...
                        <asp:Table class="table table-bordered table-light table-responsive text-center" runat="server">
                            ...
                            <asp:TableRow>
                                <asp:TableCell Style="background-color: white; font-size: 14px">
                                    <asp:TextBox runat="server" ID="txt_priApellido" BorderStyle="None" Style="background-color: transparent; width: 100%; text-align: center" ReadOnly="true"></asp:TextBox>
                                </asp:TableCell>
                                <asp:TableCell Style="background-color: white; font-size: 14px">
                                    <asp:TextBox runat="server" ID="txt_segApellido" BorderStyle="None" Style="background-color: transparent; width: 100%; text-align: center" ReadOnly="true"></asp:TextBox>
                                </asp:TableCell>
                                <asp:TableCell Style="background-color: white; font-size: 14px">
                                    <asp:TextBox runat="server" ID="txt_priNombre" BorderStyle="None" Style="background-color: transparent; width: 100%; text-align: center" ReadOnly="true"></asp:TextBox>
                                </asp:TableCell>
                                <asp:TableCell Style="background-color: white; font-size: 14px">
                                    <asp:TextBox runat="server" ID="txt_segNombre" BorderStyle="None" Style="background-color: transparent; width: 100%; text-align: center" ReadOnly="true"></asp:TextBox>
                                </asp:TableCell>
                                <asp:TableCell Style="background-color: white; font-size: 14px">
                                    <asp:TextBox runat="server" ID="txt_sexo" BorderStyle="None" Style="background-color: transparent; width: 100%; text-align: center" ReadOnly="true"></asp:TextBox>
                                </asp:TableCell>
                                <asp:TableCell Style="background-color: white; font-size: 14px; width: 155px">
                                    <asp:TextBox runat="server" ID="txt_edad" BorderStyle="None" Style="background-color: transparent; width: 100%; text-align: center" ReadOnly="true"></asp:TextBox>
                                </asp:TableCell>
                                <asp:TableCell Style="background-color: white; font-size: 14px">
                                    <asp:CheckBox ID="ckb_catolica" Checked="false" runat="server" />
                                ...
                                <asp:TableCell Style="background-color: white; font-size: 14px">
                                    <asp:CheckBox ID="ckb_evangelica" Checked="false" runat="server" />
                                ...
                                <asp:TableCell Style="background-color: white; font-size: 14px">
                                    <asp:CheckBox ID="cbk_testigo" Checked="false" runat="server" />
                                ...
                                <asp:TableCell Style="background-color: white; font-size: 14px">
                                    <asp:CheckBox ID="cbk_mormona" Checked="false" runat="server" />
                                ...
                                <asp:TableCell Style="background-color: white; font-size: 14px">
                                    <asp:CheckBox ID="cbk_otrareligion" Checked="false" runat="server" />
                        ...
                        <asp:Table class="table table-bordered table-light table-responsive text-center" runat="server">
                            ...
                            <asp:TableRow>
                                <asp:TableCell Style="background-color: white">
                                    <asp:CheckBox ID="cbk_lesbiana" Checked="false" runat="server" />
                                ...
                                <asp:TableCell Style="background-color: white">
                                    <asp:CheckBox ID="cbk_gay" Checked="false" runat="server" />
                                ...
                                <asp:TableCell Style="background-color: white">
                                    <asp:CheckBox ID="cbk_bisexual" Checked="false" runat="server" />
                                ...
                                <asp:TableCell Style="background-color: white">
                                    <asp:CheckBox ID="cbk_heterosexual" Checked="false" runat="server" />
                                ...
                                <asp:TableCell Style="background-color: white">
                                    <asp:CheckBox ID="cbk_noRespondeOriSex" Checked="false" runat="server" />
                                ...
                                <asp:TableCell Style="background-color: white">
                                    <asp:CheckBox ID="cbk_femenino" Checked="false" runat="server" />
                                ...
                                <asp:TableCell Style="background-color: white">
                                    <asp:CheckBox ID="cbk_masculino" Checked="false" runat="server" />
                                ...
                                <asp:TableCell Style="background-color: white">
                                    <asp:CheckBox ID="cbk_transfemenino" Checked="false" runat="server" />
                                ...
                                <asp:TableCell Style="background-color: white">
                                    <asp:CheckBox ID="cbk_transmasculino" Checked="false" runat="server" />
                                ...
                                <asp:TableCell Style="background-color: white">
                                    <asp:CheckBox ID="cbk_noRespondeIdeGen" Checked="false" runat="server" />
                                ...
                                <asp:TableCell Style="background-color: white">
                                    <asp:CheckBox ID="cbk_sidiscapacidad" Checked="false" runat="server" />
                                ...
                                <asp:TableCell Style="background-color: white">
                                    <asp:CheckBox ID="cbk_nodiscapacidad" Checked="false" runat="server" />
                                ...
                                <asp:TableCell Style="background-color: white; font-size: 14px">
                                    <asp:TextBox runat="server" ID="txt_puestodetrabajociuo" BorderStyle="None" Style="background-color: transparent; width: 100%; text-align: center" TextMode="MultiLine" Rows="4" ReadOnly="true"></asp:TextBox>
                                </asp:TableCell>
                                <asp:TableCell Style="background-color: white; font-size: 14px">
                                    <asp:TextBox runat="server" ID="txt_areadetrabajo" BorderStyle="None" Style="background-color: transparent; width: 100%; text-align: center" ReadOnly="true"></asp:TextBox>
                                </asp:TableCell>
                            </asp:TableRow>
                        </asp:Table>
                        <asp:Table class="table table-bordered table-light table-responsive text-center" runat="server">
                ...
                <div class="card" style="width: auto;">
                    ...
                    <asp:Table class="table table-bordered table-light table-responsive text-center" runat="server">
                        ...
                        <asp:TableRow>
                            ...
                            <asp:TableCell Style="background-color: white; font-size: 14px">
                                <asp:CheckBox ID="ckb_siVidSexAntGinObste" Checked="false" runat="server" />
                            ...
                            <asp:TableCell Style="background-color: white; font-size: 14px">
                                <asp:CheckBox ID="ckb_noVidSexAntGinObste" Checked="false" runat="server" />
                            ...
                            <asp:TableCell Style="background-color: white; font-size: 14px">
                                <asp:CheckBox ID="ckb_siMetPlaniAntGinObste" Checked="false" runat="server" />
                            ...
                            <asp:TableCell Style="background-color: white; font-size: 14px">
                                <asp:CheckBox ID="ckb_noMetPlaniAntGinObste" Checked="false" runat="server" />
                    ...
                    <asp:Table class="table table-bordered table-light table-responsive text-center" runat="server">
                        ...
                        <asp:TableRow>
                            ...
                            <asp:TableCell Style="background-color: white; font-size: 14px">
                                <asp:CheckBox ID="ckb_siPapaniAntGinObste" Checked="false" runat="server" />
                            ...
                            <asp:TableCell Style="background-color: white; font-size: 14px">
                                <asp:CheckBox ID="ckb_noPapaniAntGinObste" Checked="false" runat="server" />
                            ...
                            <asp:TableCell Style="background-color: white; font-size: 14px">
                                <asp:CheckBox ID="ckb_siEcoMamaAntGinObste" Checked="false" runat="server" />
                            ...
                            <asp:TableCell Style="background-color: white; font-size: 14px">
                                <asp:CheckBox ID="ckb_noEcoMamaAntGinObste" Checked="false" runat="server" />
                        ...
                        <asp:TableRow>
                            ...
                            <asp:TableCell Style="background-color: white; font-size: 14px">
                                <asp:CheckBox ID="ckb_siColposAntGinObste" Checked="false" runat="server" />
                            ...
                            <asp:TableCell Style="background-color: white; font-size: 14px">
                                <asp:CheckBox ID="ckb_noColposAntGinObste" Checked="false" runat="server" />
                            ...
                            <asp:TableCell Style="background-color: white; font-size: 14px">
                                <asp:CheckBox ID="ckb_siMamograAntGinObste" Checked="false" runat="server" />
                            ...
                            <asp:TableCell Style="background-color: white; font-size: 14px">
                                <asp:CheckBox ID="ckb_noMamograAntGinObste" Checked="false" runat="server" />
                    ...
                    <asp:Table class="table table-bordered table-light table-responsive text-center" runat="server">
                        ...
                        <asp:TableRow>
                            ...
                            <asp:TableCell Style="background-color: white; font-size: 14px">
                                <asp:CheckBox ID="ckb_siExaRealiAntProstaAntReproMascu" Checked="false" runat="server" />
                            ...
                            <asp:TableCell Style="background-color: white; font-size: 14px">
                                <asp:CheckBox ID="ckb_noExaRealiAntProstaAntReproMascu" Checked="false" runat="server" />
                            ...
                            <asp:TableCell RowSpan="2" Style="background-color: white; font-size: 14px">
                                <asp:CheckBox ID="ckb_siMetPlaniAntReproMascu" Checked="false" runat="server" />
                            ...
                            <asp:TableCell RowSpan="2" Style="background-color: white; font-size: 14px">
                                <asp:CheckBox ID="ckb_noMetPlaniAntReproMascu" Checked="false" runat="server" />
                        ...
                        <asp:TableRow>
                            ...
                            <asp:TableCell Style="background-color: white; font-size: 14px">
                                <asp:CheckBox ID="ckb_siExaRealiEcoProstaAntReproMascu" Checked="false" runat="server" />
                            ...
                            <asp:TableCell Style="background-color: white; font-size: 14px">
                                <asp:CheckBox ID="ckb_noExaRealiEcoProstaAntReproMascu" Checked="false" runat="server" />
                ...
                <div class="card" style="width: auto;">
                    ...
                    <asp:Table class="table table-bordered table-light table-responsive text-center" runat="server">
                        ...
                        <asp:TableRow>
                            ...
                            <asp:TableCell Style="background-color: white; font-size: 14px">
                                <asp:CheckBox ID="ckb_mecanico" Checked="false" runat="server" />
                            ...
                            <asp:TableCell Style="background-color: white; font-size: 14px">
                                <asp:CheckBox ID="ckb_quimico" Checked="false" runat="server" />
                            ...
                            <asp:TableCell Style="background-color: white; font-size: 14px">
                                <asp:CheckBox ID="ckb_biologico" Checked="false" runat="server" />
                            ...
                            <asp:TableCell Style="background-color: white; font-size: 14px">
                                <asp:CheckBox ID="ckb_ergonomico" Checked="false" runat="server" />
                            ...
                            <asp:TableCell Style="background-color: white; font-size: 14px">
                                <asp:CheckBox ID="ckb_psicosocial" Checked="false" runat="server" />
                        ...
                        <asp:TableRow>
                            ...
                            <asp:TableCell Style="background-color: white; font-size: 14px">
                                <asp:CheckBox ID="ckb_mecanico2" Checked="false" runat="server" />
                            ...
                            <asp:TableCell Style="background-color: white; font-size: 14px">
                                <asp:CheckBox ID="ckb_quimico2" Checked="false" runat="server" />
                            ...
                            <asp:TableCell Style="background-color: white; font-size: 14px">
                                <asp:CheckBox ID="ckb_biologico2" Checked="false" runat="server" />
                            ...
                            <asp:TableCell Style="background-color: white; font-size: 14px">
                                <asp:CheckBox ID="ckb_ergonomico2" Checked="false" runat="server" />
                            ...
                            <asp:TableCell Style="background-color: white; font-size: 14px">
                                <asp:CheckBox ID="ckb_psicosocial2" Checked="false" runat="server" />
                        ...
                        <asp:TableRow>
                            ...
                            <asp:TableCell Style="background-color: white; font-size: 14px">
                                <asp:CheckBox ID="ckb_mecanico3" Checked="false" runat="server" />
                            ...
                            <asp:TableCell Style="background-color: white; font-size: 14px">
                                <asp:CheckBox ID="ckb_quimico3" Checked="false" runat="server" />
                            ...
                            <asp:TableCell Style="background-color: white; font-size: 14px">
                                <asp:CheckBox ID="ckb_biologico3" Checked="false" runat="server" />
                            ...
                            <asp:TableCell Style="background-color: white; font-size: 14px">
                                <asp:CheckBox ID="ckb_ergonomico3" Checked="false" runat="server" />
                            ...
                            <asp:TableCell Style="background-color: white; font-size: 14px">
                                <asp:CheckBox ID="ckb_psicosocial3" Checked="false" runat="server" />
                        ...
                        <asp:TableRow>
                            ...
                            <asp:TableCell Style="background-color: white; font-size: 14px">
                                <asp:CheckBox ID="ckb_mecanico4" Checked="false" runat="server" />
                            ...
                            <asp:TableCell Style="background-color: white; font-size: 14px">
                                <asp:CheckBox ID="ckb_quimico4" Checked="false" runat="server" />
                            ...
                            <asp:TableCell Style="background-color: white; font-size: 14px">
                                <asp:CheckBox ID="ckb_biologico4" Checked="false" runat="server" />
                            ...
                            <asp:TableCell Style="background-color: white; font-size: 14px">
                                <asp:CheckBox ID="ckb_ergonomico4" Checked="false" runat="server" />
                            ...
                            <asp:TableCell Style="background-color: white; font-size: 14px">
                                <asp:CheckBox ID="ckb_psicosocial4" Checked="false" runat="server" />
                    ...
                    <asp:Table class="table table-bordered table-light table-responsive text-center" runat="server">
                        <asp:TableRow>
                            ...
                            <asp:TableCell style="width:50px; background-color: white; font-size: 14px">
                                <asp:CheckBox ID="ckb_siAccTrabDescrip" Checked="false" runat="server" />
                                <%--<asp:TextBox runat="server" ID="txt_siAccTrabDescrip" BorderStyle="None" Style="background-color: transparent; width: 100%; text-align: center"></asp:TextBox>--%>
                            </asp:TableCell>
                            ...
                            <asp:TableCell style="width:50px; background-color: white; font-size: 14px">
                                <asp:CheckBox ID="ckb_noAccTrabDescrip" Checked="false" runat="server" />
                                <%--<asp:TextBox runat="server" ID="txt_noAccTrabDescrip" BorderStyle="None" Style="background-color: transparent; width: 100%; text-align: center"></asp:TextBox>--%>
                            </asp:TableCell>
                    ...
                    <asp:Table class="table table-bordered table-light table-responsive text-center" runat="server">
                        <asp:TableRow>
                            ...
                            <asp:TableCell style="width:50px; background-color: white; font-size:15px">SI</asp:TableCell>
                            <asp:TableCell style="width:50px; background-color: white; font-size: 14px">
                                <asp:CheckBox ID="ckb_siprofesional" Checked="false" runat="server" />
                            ...
                            <asp:TableCell style="width:50px; background-color: white; font-size:15px">NO</asp:TableCell>
                            <asp:TableCell style="width:50px; background-color: white; font-size: 14px">
                                <asp:CheckBox ID="ckb_noprofesional" Checked="false" runat="server" />
                    ...
                    <asp:Table class="table table-bordered table-light table-responsive text-center" runat="server">
                        ...
                        <asp:TableRow>
                            ...
                            <asp:TableCell style="background-color: #cdfecc; font-size:15px">
                                ...
                                <div class="col">
                                    <asp:TextBox runat="server" ID="txt_otrosFisico" BorderStyle="None" Style="background-color: transparent; width: 100%; text-align: center" placeholder="-----------"></asp:TextBox>
                                </div>                                
                            </asp:TableCell>                            
                        </asp:TableRow>
                        <asp:TableRow>
                    ...
                    <asp:Table class="table table-bordered table-light table-responsive text-center" runat="server">
                        ...
                        <asp:TableRow>
                            ...
                            <asp:TableCell style="background-color: white; font-size: 14px">
                                ...
                                <%--<asp:TextBox runat="server" ID="txt_solidos4" BorderStyle="None" Style="background-color: transparent; width: 100%; text-align: center" placeholder="-"></asp:TextBox>--%>
                            </asp:TableCell>
                            <asp:TableCell style="background-color: white; font-size: 14px">
                    ...
                    <asp:Table class="table table-bordered table-light table-responsive text-center" runat="server">
                        ...
                        <asp:TableRow>
                            ...
                            <asp:TableCell style="background-color: white; font-size: 14px">
                                ...
                                <%--<asp:TextBox runat="server" ID="ckb_virus" BorderStyle="None" Style="background-color: transparent; width: 100%; text-align: center" placeholder=""></asp:TextBox>--%>
                            </asp:TableCell>
                            <asp:TableCell style="background-color: white; font-size: 14px">
                            ...
                            <asp:TableCell style="background-color: white; font-size: 14px">
                                ...
                                <%--<asp:TextBox runat="server" ID="ckb_manmanualcargas" BorderStyle="None" Style="background-color: transparent; width: 100%; text-align: center" placeholder="-"></asp:TextBox>--%>
                            </asp:TableCell>
                            <asp:TableCell style="background-color: white; font-size: 14px">
                        ...
                        <asp:TableRow>
                            ...
                            <asp:TableCell style="background-color: white; font-size: 14px">
                                ...
                                <%--<asp:TextBox runat="server" ID="ckb_virus2" BorderStyle="None" Style="background-color: transparent; width: 100%; text-align: center" placeholder=""></asp:TextBox>--%>
                            </asp:TableCell>
                            <asp:TableCell style="background-color: white; font-size: 14px">
                            ...
                            <asp:TableCell style="background-color: white; font-size: 14px">
                                ...
                                <%--<asp:TextBox runat="server" ID="ckb_manmanualcargas2" BorderStyle="None" Style="background-color: transparent; width: 100%; text-align: center" placeholder="-"></asp:TextBox>--%>
                            </asp:TableCell>
                            <asp:TableCell style="background-color: white; font-size: 14px">
                        ...
                        <asp:TableRow>
                            ...
                            <asp:TableCell style="background-color: white; font-size: 14px">
                                ...
                                <%--<asp:TextBox runat="server" ID="ckb_virus3" BorderStyle="None" Style="background-color: transparent; width: 100%; text-align: center" placeholder=""></asp:TextBox>--%>
                            </asp:TableCell>
                            <asp:TableCell style="background-color: white; font-size: 14px">
                            ...
                            <asp:TableCell style="background-color: white; font-size: 14px">
                                ...
                                <%--<asp:TextBox runat="server" ID="ckb_manmanualcargas3" BorderStyle="None" Style="background-color: transparent; width: 100%; text-align: center" placeholder="-"></asp:TextBox>--%>
                            </asp:TableCell>
                            <asp:TableCell style="background-color: white; font-size: 14px">
                        ...
                        <asp:TableRow>
                            ...
                            <asp:TableCell style="background-color: white; font-size: 14px">
                                ...
                                <%--<asp:TextBox runat="server" ID="ckb_virus4" BorderStyle="None" Style="background-color: transparent; width: 100%; text-align: center" placeholder=""></asp:TextBox>--%>
                            </asp:TableCell>
                            <asp:TableCell style="background-color: white; font-size: 14px">
                                <asp:CheckBox ID="ckb_hongos4" Checked="false" runat="server" />
                                <%--<asp:TextBox runat="server" ID="ckb_hongos4" BorderStyle="None" Style="background-color: transparent; width: 100%; text-align: center"></asp:TextBox>--%>
                            </asp:TableCell>
                            <asp:TableCell style="background-color: white; font-size: 14px">
                                <asp:CheckBox ID="ckb_bacterias4" Checked="false" runat="server" />
                                <%--<asp:TextBox runat="server" ID="ckb_bacterias4" BorderStyle="None" Style="background-color: transparent; width: 100%; text-align: center"></asp:TextBox>--%>
                            </asp:TableCell>
                            <asp:TableCell style="background-color: white; font-size: 14px">
                                <asp:CheckBox ID="ckb_parasitos4" Checked="false" runat="server" />
                                <%--<asp:TextBox runat="server" ID="ckb_parasitos4" BorderStyle="None" Style="background-color: transparent; width: 100%; text-align: center"></asp:TextBox>--%>
                            </asp:TableCell>
                            <asp:TableCell style="background-color: white; font-size: 14px">
                                <asp:CheckBox ID="ckb_expoavectores4" Checked="false" runat="server" />
                                <%--<asp:TextBox runat="server" ID="ckb_expoavectores4" BorderStyle="None" Style="background-color: transparent; width: 100%; text-align: center"></asp:TextBox>--%>
                            </asp:TableCell>
                            <asp:TableCell style="background-color: white; font-size: 14px">
                                <asp:CheckBox ID="ckb_expoanimselvaticos4" Checked="false" runat="server" />
                                <%--<asp:TextBox runat="server" ID="ckb_expoanimselvaticos4" BorderStyle="None" Style="background-color: transparent; width: 100%; text-align: center"></asp:TextBox>--%>
                            </asp:TableCell>
                            <asp:TableCell style="background-color: white; font-size: 14px">
                                <asp:CheckBox ID="ckb_otrosBiologico4" Checked="false" runat="server" />
                                <%--<asp:TextBox runat="server" ID="ckb_otrosBiologico4" BorderStyle="None" Style="background-color: transparent; width: 100%; text-align: center"></asp:TextBox>--%>
                            </asp:TableCell>
                            <asp:TableCell style="background-color: white; font-size: 14px">
                                <asp:CheckBox ID="ckb_manmanualcargas4" Checked="false" runat="server" />
                                <%--<asp:TextBox runat="server" ID="ckb_manmanualcargas4" BorderStyle="None" Style="background-color: transparent; width: 100%; text-align: center" placeholder="-"></asp:TextBox>--%>
                            </asp:TableCell>
                            <asp:TableCell style="background-color: white; font-size: 14px">
                                <asp:CheckBox ID="ckb_movrepetitivo4" Checked="false" runat="server" />
                                <%--<asp:TextBox runat="server" ID="ckb_movrepetitivo4" BorderStyle="None" Style="background-color: transparent; width: 100%; text-align: center"></asp:TextBox>--%>
                            </asp:TableCell>
                            <asp:TableCell style="background-color: white; font-size: 14px">
                                <asp:CheckBox ID="ckb_postforzadas4" Checked="false" runat="server" />
                                <%--<asp:TextBox runat="server" ID="ckb_postforzadas4" BorderStyle="None" Style="background-color: transparent; width: 100%; text-align: center"></asp:TextBox>--%>
                            </asp:TableCell>
                            <asp:TableCell style="background-color: white; font-size: 14px">
                                <asp:CheckBox ID="ckb_trabajopvd4" Checked="false" runat="server" />
                                <%--<asp:TextBox runat="server" ID="ckb_trabajopvd4" BorderStyle="None" Style="background-color: transparent; width: 100%; text-align: center"></asp:TextBox>--%>
                            </asp:TableCell>
                            <asp:TableCell style="background-color: white; font-size: 14px">
                                <asp:CheckBox ID="ckb_otrosErgonomico4" Checked="false" runat="server" />
                                <%--<asp:TextBox runat="server" ID="ckb_otrosErgonomico4" BorderStyle="None" Style="background-color: transparent; width: 100%; text-align: center"></asp:TextBox>--%>
                            </asp:TableCell>                            
                        </asp:TableRow>
                    </asp:Table>
                    <asp:Table class="table table-bordered table-light table-responsive text-center" runat="server">
                        ...
                        <asp:TableRow>
                            <asp:TableCell style="background-color: white; font-size: 14px">
                                ...
                                <%--<asp:TextBox runat="server" ID="ckb_montrabajo" BorderStyle="None" Style="background-color: transparent; width: 100%; text-align: center" placeholder="-"></asp:TextBox>--%>
                            </asp:TableCell>
                            <asp:TableCell style="background-color: white; font-size: 14px">
                            ...
                            <asp:TableCell style="background-color: white; font-size: 14px">
                                ...
                                <%--<asp:TextBox runat="server" ID="ckb_otrosPsicosocial" BorderStyle="None" Style="background-color: transparent; width: 100%; text-align: center"></asp:TextBox>--%>
                            </asp:TableCell>
                            <asp:TableCell style="background-color: white; font-size: 14px">
                        ...
                        <asp:TableRow>
                            <asp:TableCell style="background-color: white; font-size: 14px">
                                ...
                                <%--<asp:TextBox runat="server" ID="ckb_montrabajo2" BorderStyle="None" Style="background-color: transparent; width: 100%; text-align: center" placeholder="-"></asp:TextBox>--%>
                            </asp:TableCell>
                            <asp:TableCell style="background-color: white; font-size: 14px">
                            ...
                            <asp:TableCell style="background-color: white; font-size: 14px">
                                ...
                                <%--<asp:TextBox runat="server" ID="ckb_otrosPsicosocial2" BorderStyle="None" Style="background-color: transparent; width: 100%; text-align: center"></asp:TextBox>--%>
                            </asp:TableCell>
                            <asp:TableCell style="background-color: white; font-size: 14px">
                        ...
                        <asp:TableRow>
                            <asp:TableCell style="background-color: white; font-size: 14px">
                                ...
                                <%--<asp:TextBox runat="server" ID="ckb_montrabajo3" BorderStyle="None" Style="background-color: transparent; width: 100%; text-align: center" placeholder="-"></asp:TextBox>--%>
                            </asp:TableCell>
                            <asp:TableCell style="background-color: white; font-size: 14px">
                            ...
                            <asp:TableCell style="background-color: white; font-size: 14px">
                                ...
                                <%--<asp:TextBox runat="server" ID="ckb_otrosPsicosocial3" BorderStyle="None" Style="background-color: transparent; width: 100%; text-align: center"></asp:TextBox>--%>
                            </asp:TableCell>
                            <asp:TableCell style="background-color: white; font-size: 14px">
                        ...
                        <asp:TableRow>
                            <asp:TableCell style="background-color: white; font-size: 14px">
                                ...
                                <%--<asp:TextBox runat="server" ID="ckb_montrabajo4" BorderStyle="None" Style="background-color: transparent; width: 100%; text-align: center" placeholder="-"></asp:TextBox>--%>
                            </asp:TableCell>
                            <asp:TableCell style="background-color: white; font-size: 14px">
                                <asp:CheckBox ID="ckb_sobrecargalaboral4" Checked="false" runat="server" />
                                <%--<asp:TextBox runat="server" ID="ckb_sobrecargalaboral4" BorderStyle="None" Style="background-color: transparent; width: 100%; text-align: center"></asp:TextBox>--%>
                            </asp:TableCell>
                            <asp:TableCell style="background-color: white; font-size: 14px">
                                <asp:CheckBox ID="ckb_minustarea4" Checked="false" runat="server" />
                                <%--<asp:TextBox runat="server" ID="ckb_minustarea4" BorderStyle="None" Style="background-color: transparent; width: 100%; text-align: center"></asp:TextBox>--%>
                            </asp:TableCell>
                            <asp:TableCell style="background-color: white; font-size: 14px">
                                <asp:CheckBox ID="ckb_altarespon4" Checked="false" runat="server" />
                                <%--<asp:TextBox runat="server" ID="ckb_altarespon4" BorderStyle="None" Style="background-color: transparent; width: 100%; text-align: center"></asp:TextBox>--%>
                            </asp:TableCell>
                            <asp:TableCell style="background-color: white; font-size: 14px">
                                <asp:CheckBox ID="ckb_automadesiciones4" Checked="false" runat="server" />
                                <%--<asp:TextBox runat="server" ID="ckb_automadesiciones4" BorderStyle="None" Style="background-color: transparent; width: 100%; text-align: center"></asp:TextBox>--%>
                            </asp:TableCell>
                            <asp:TableCell style="background-color: white; font-size: 14px">
                                <asp:CheckBox ID="ckb_supyestdireficiente4" Checked="false" runat="server" />
                                <%--<asp:TextBox runat="server" ID="ckb_supyestdireficiente4" BorderStyle="None" Style="background-color: transparent; width: 100%; text-align: center"></asp:TextBox>--%>
                            </asp:TableCell>
                            <asp:TableCell style="background-color: white; font-size: 14px">
                                <asp:CheckBox ID="ckb_conflictorol4" Checked="false" runat="server" />
                                <%--<asp:TextBox runat="server" ID="ckb_conflictorol4" BorderStyle="None" Style="background-color: transparent; width: 100%; text-align: center"></asp:TextBox>--%>
                            </asp:TableCell>
                            <asp:TableCell style="background-color: white; font-size: 14px">
                                <asp:CheckBox ID="ckb_faltaclarfunciones4" Checked="false" runat="server" />
                                <%--<asp:TextBox runat="server" ID="ckb_faltaclarfunciones4" BorderStyle="None" Style="background-color: transparent; width: 100%; text-align: center"></asp:TextBox>--%>
                            </asp:TableCell>
                            <asp:TableCell style="background-color: white; font-size: 14px">
                                <asp:CheckBox ID="ckb_incorrdistrabajo4" Checked="false" runat="server" />
                                <%--<asp:TextBox runat="server" ID="ckb_incorrdistrabajo4" BorderStyle="None" Style="background-color: transparent; width: 100%; text-align: center"></asp:TextBox>--%>
                            </asp:TableCell>
                            <asp:TableCell style="background-color: white; font-size: 14px">
                                <asp:CheckBox ID="ckb_turnorotat4" Checked="false" runat="server" />
                                <%--<asp:TextBox runat="server" ID="ckb_turnorotat4" BorderStyle="None" Style="background-color: transparent; width: 100%; text-align: center"></asp:TextBox>--%>
                            </asp:TableCell>
                            <asp:TableCell style="background-color: white; font-size: 14px">
                                <asp:CheckBox ID="ckb_relacinterpersonales4" Checked="false" runat="server" />
                                <%--<asp:TextBox runat="server" ID="ckb_relacinterpersonales4" BorderStyle="None" Style="background-color: transparent; width: 100%; text-align: center"></asp:TextBox>--%>
                            </asp:TableCell>
                            <asp:TableCell style="background-color: white; font-size: 14px">
                                <asp:CheckBox ID="ckb_inestalaboral4" Checked="false" runat="server" />
                                <%--<asp:TextBox runat="server" ID="ckb_inestalaboral4" BorderStyle="None" Style="background-color: transparent; width: 100%; text-align: center"></asp:TextBox>--%>
                            </asp:TableCell>
                            <asp:TableCell style="background-color: white; font-size: 14px">
                                <asp:CheckBox ID="ckb_otrosPsicosocial4" Checked="false" runat="server" />
                                <%--<asp:TextBox runat="server" ID="ckb_otrosPsicosocial4" BorderStyle="None" Style="background-color: transparent; width: 100%; text-align: center"></asp:TextBox>--%>
                            </asp:TableCell>
                            <asp:TableCell style="background-color: white; font-size: 14px">
                    ...
                    <asp:Table class="table table-bordered table-light table-responsive text-center" runat="server">
                        <asp:TableRow>
                            ...
                            <asp:TableCell style="width:50px; background-color: white; font-size: 14px">
                                ...
                                <%--<asp:TextBox runat="server" ID="ckb_pielanexos" BorderStyle="None" Style="background-color: transparent; width: 100%; text-align: center" placeholder="-"></asp:TextBox>--%>
                            </asp:TableCell>
                            ...
                            <asp:TableCell style="width:50px; background-color: white; font-size: 14px">
                                ...
                                <%--<asp:TextBox runat="server" ID="ckb_respiratorio" BorderStyle="None" Style="background-color: transparent; width: 100%; text-align: center" placeholder="-"></asp:TextBox>--%>
                            </asp:TableCell>
                            ...
                            <asp:TableCell style="width:50px; background-color: white; font-size: 14px">
                                ...
                                <%--<asp:TextBox runat="server" ID="ckb_digestivo" BorderStyle="None" Style="background-color: transparent; width: 100%; text-align: center" placeholder="-"></asp:TextBox>--%>
                            </asp:TableCell>
                            ...
                            <asp:TableCell style="width:50px; background-color: white; font-size: 14px">
                                ...
                                <%--<asp:TextBox runat="server" ID="ckb_musculosesqueleticos" BorderStyle="None" Style="background-color: transparent; width: 100%; text-align: center" placeholder="-"></asp:TextBox>--%>
                            </asp:TableCell>
                            ...
                            <asp:TableCell style="width:50px; background-color: white; font-size: 14px">
                                ...
                                <%--<asp:TextBox runat="server" ID="ckb_hemolinfatico" BorderStyle="None" Style="background-color: transparent; width: 100%; text-align: center" placeholder="-"></asp:TextBox>--%>
                            </asp:TableCell>
                        </asp:TableRow>
                        <asp:TableRow>
                            ...
                            <asp:TableCell style="width:50px; background-color: white; font-size: 14px">
                                ...
                                <%--<asp:TextBox runat="server" ID="ckb_organossentidos" BorderStyle="None" Style="background-color: transparent; width: 100%; text-align: center" placeholder="-"></asp:TextBox>--%>
                            </asp:TableCell>
                            ...
                            <asp:TableCell style="width:50px; background-color: white; font-size: 14px">
                                ...
                                <%--<asp:TextBox runat="server" ID="ckb_cardiovascular" BorderStyle="None" Style="background-color: transparent; width: 100%; text-align: center" placeholder="-"></asp:TextBox>--%>
                            </asp:TableCell>
                            ...
                            <asp:TableCell style="width:50px; background-color: white; font-size: 14px">
                                ...
                                <%--<asp:TextBox runat="server" ID="ckb_genitourinario" BorderStyle="None" Style="background-color: transparent; width: 100%; text-align: center" placeholder="-"></asp:TextBox>--%>
                            </asp:TableCell>
                            ...
                            <asp:TableCell style="width:50px; background-color: white; font-size: 14px">
                                ...
                                <%--<asp:TextBox runat="server" ID="ckb_endocrino" BorderStyle="None" Style="background-color: transparent; width: 100%; text-align: center" placeholder="-"></asp:TextBox>--%>
                            </asp:TableCell>
                            ...
                            <asp:TableCell style="width:50px; background-color: white; font-size: 14px">
                                ...
                                <%--<asp:TextBox runat="server" ID="ckb_nervioso" BorderStyle="None" Style="background-color: transparent; width: 100%; text-align: center" placeholder="-"></asp:TextBox>--%>
                            </asp:TableCell>
                        </asp:TableRow>
                        <asp:TableRow>
                        ...
                        <asp:Table class="table table-bordered table-light table-responsive text-center" runat="server">
                            ...
                            <asp:TableRow>
                                ...
                                <asp:TableCell style="background-color: white; font-size: 14px">
                                    ...
                                    <%--<asp:TextBox runat="server" ID="ckb_pre" BorderStyle="None" Style="background-color: transparent; width: 100%; text-align: center" placeholder="-"></asp:TextBox>--%>
                                </asp:TableCell>
                                <asp:TableCell style="background-color: white; font-size: 14px">
                                    <asp:CheckBox ID="ckb_def" Checked="false" runat="server" />
                                    <%--<asp:TextBox runat="server" ID="ckb_def" BorderStyle="None" Style="background-color: transparent; width: 100%; text-align: center" placeholder="-"></asp:TextBox>--%>
                                </asp:TableCell>
                            </asp:TableRow>
                            <asp:TableRow>
                                ...
                                <asp:TableCell style="background-color: white; font-size: 14px">
                                    ...
                                    <%--<asp:TextBox runat="server" ID="ckb_pre2" BorderStyle="None" Style="background-color: transparent; width: 100%; text-align: center" placeholder="-"></asp:TextBox>--%>
                                </asp:TableCell>
                                <asp:TableCell style="background-color: white; font-size: 14px">
                                    <asp:CheckBox ID="ckb_def2" Checked="false" runat="server" />
                                    <%--<asp:TextBox runat="server" ID="ckb_def2" BorderStyle="None" Style="background-color: transparent; width: 100%; text-align: center" placeholder="-"></asp:TextBox>--%>
                                </asp:TableCell>
                            </asp:TableRow>
                            <asp:TableRow>
                                ...
                                <asp:TableCell style="background-color: white; font-size: 14px">
                                    ...
                                    <%--<asp:TextBox runat="server" ID="ckb_pre3" BorderStyle="None" Style="background-color: transparent; width: 100%; text-align: center" placeholder="-"></asp:TextBox>--%>
                                </asp:TableCell>
                                <asp:TableCell style="background-color: white; font-size: 14px">
                                    <asp:CheckBox ID="ckb_def3" Checked="false" runat="server" />
                                    <%--<asp:TextBox runat="server" ID="ckb_def3" BorderStyle="None" Style="background-color: transparent; width: 100%; text-align: center" placeholder="-"></asp:TextBox>--%>
                                </asp:TableCell>
                            </asp:TableRow>
                        </asp:Table>
                    </div>
                        ...
                        <asp:Table class="table table-bordered table-light table-responsive text-center" runat="server">
                            <asp:TableRow>
                                ...
                                <asp:TableCell Style="width: 50px; background-color: white; font-size: 14px">
                                    ...
                                    <%--<asp:TextBox runat="server" ID="ckb_apto" BorderStyle="None" Style="background-color: transparent; width: 100%; text-align: center" placeholder="-"></asp:TextBox>--%>
                                </asp:TableCell>
                        ...
                        <asp:Table class="table table-bordered table-light table-responsive text-center" runat="server">
                            <asp:TableRow>
                                ...
                                <asp:TableCell Style="width: 150px; background-color: white; font-size: 14px">
                                    <asp:TextBox runat="server" BorderStyle="None" ID="txt_fechahora" Style="background-color: transparent; width: 100%; text-align: center" TextMode="DateTimeLocal"></asp:TextBox>
                                </asp:TableCell>
