...
namespace SistemaECU911.Template.Views
{
    public partial class Inmunizaciones : System.Web.UI.Page
    {
        ...
        private Tbl_InmunizacionesInmunizaciones inmu = new Tbl_InmunizacionesInmunizaciones();
        ...
        private void CargarDatosModificar()
        {
            try
            {
                if (Request["cod"] != null)
                {
                    ...
                    inmu = CN_Inmunizaciones.obtenerInmunizaciones(perso);

                    btn_guardarinmunizaciones.Visible = true;

                    if (per != null || inmu != null)
                    {
                        //A
                        txt_priNombre.Text = per.Per_priNombre.ToString();
                        txt_segNombre.Text = per.Per_segNombre.ToString();
        ...
        private void guardar_modificar_datos(int perid, int inmuid)
        {
            if (perid == 0 || inmuid == 0)
            {
        ...
        private void GuardarInmunizaciones()
        {
            try
            {
                ...
                // B
                inmu = new Tbl_InmunizacionesInmunizaciones();
        ...
        protected void btn_guardarinmunizaciones_Click(object sender, EventArgs e)
        {
             guardar_modificar_datos(Convert.ToInt32(Request["cod"]), Convert.ToInt32(per.Per_id.ToString()));
        }

        protected void btn_modificarinmunizaciones_Click(object sender, EventArgs e)
        {

        }

        protected void btn_cancelarinmunizaciones_Click(object sender, EventArgs e)
        {
