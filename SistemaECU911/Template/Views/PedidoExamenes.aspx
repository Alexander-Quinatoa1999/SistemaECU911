...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container">
            <div class="row align-items-start">
                <div class="card border-dark mb-3 bg-transparent table-responsive" style="margin: auto">
            ...
            <div class="card border-dark bg-transparent mb-3 table-responsive" style="margin: auto">
                <div class="card-body">
                    <div class="row">
                        <div class="col">
