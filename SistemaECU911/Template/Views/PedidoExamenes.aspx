...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container" style="background-color: white">
        ...
        <div class="card border-0" style="width: auto;">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-3 table-responsive" id="HEMATOLOGIA">
                        <b>HEMATOLOGIA</b>
                    ...
                    <div class="col-md-6 table-responsive" id="ELECTROLITOS">
                        <b>ELECTROLITOS</b>
                        <div class="form-check">
                    ...
                    <div class="col-md-3 table-responsive" id="TUMORALES">
                ...
                <div class="row">
                    <div class="col-md-3 table-responsive" id="INMUNOHEMATOLOGIA" style="margin-top: -8rem">
                    ...
                    <div class="col-md-6 table-responsive" id="SEROLOGIA" style="margin-top: -6.5rem">
                        <b>SEROLOGIA</b>
                        <div class="form-check">
                    ...
                    <div class="col-md-3 table-responsive" id="MICROBIOLOGIA">
                        <b>MICROBIOLOGIA</b>
                        <div class="form-check">
                ...
                <div class="row">
                    <div class="col-md-3 table-responsive" id="COAGULACION" style="margin-top: -10rem">
                        <b>COAGULACION</b>
                        <div class="form-check">
                    ...
                    <div class="col-md-6 table-responsive" id="HORMONAS" style="margin-top: -7rem">
                        <b>HORMONAS</b>
                        <div class="form-check">
                    ...
                    <div class="col-md-3 table-responsive" id="ESPECIALES">
                ...
                <div class="row">
                    <div class="col-md-3 table-responsive" id="SANGUINEA" style="margin-top: -16rem">
                        ...
                        <div class="form-check">
                            ...
                            <asp:Label class="form-check-label" for="Tolerancia" runat="server" Text="Glucosa:" Style="margin-left: -1.50rem;"></asp:Label>
                            ...
                            <asp:Label class="form-check-label" for="Tolerancia" runat="server" Text="Horas"></asp:Label>
                        </div>
                        <div class="form-check">
                    ...
                    <div class="col-md-6 table-responsive" id="INMUNOLOGIA">
                        <b>INMUNOLOGIA</b>
                        <div class="form-check">
                        ...
                        <div class="row">
                            <div class="form-check col" style="margin-left: 0.75rem; margin-right: 4.9rem;">
                            ...
                            <div class="form-check col" style="margin-left: -1.1rem;">
                        ...
                        <div class="row">
                            <div class="form-check col" style="margin-left: 0.75rem; margin-right: 4.2rem;">
                        ...
                        <div class="row">
                            ...
                            <div class="form-check col" style="margin-left: -4.4rem;">
                                <asp:TextBox class="form-check-input" type="checkbox" value="" ID="TextBox1" runat="server"></asp:TextBox>
                                <asp:Label class="form-check-label" for="IgG" runat="server" Text="IgG"></asp:Label>
                            </div>
                            <div class="form-check col" style="margin-left: -8.6rem;">
                        ...
                        <div class="row">
                            ...
                            <div class="form-check col" style="margin-left: 3.3rem;">
                                <asp:TextBox class="form-check-input" type="checkbox" value="" ID="TextBox12" runat="server"></asp:TextBox>
                                <asp:Label class="form-check-label" for="IgG" runat="server" Text="IgG"></asp:Label>
                            </div>
                            <div class="form-check col" style="margin-left: 6.8rem;">
                        ...
                        <div class="row">
                            ...
                            <div class="form-check col" style="margin-left: 0.8rem;">
                                <asp:TextBox class="form-check-input" type="checkbox" value="" ID="TextBox14" runat="server"></asp:TextBox>
                                <asp:Label class="form-check-label" for="IgG" runat="server" Text="IgG"></asp:Label>
                            </div>
                            <div class="form-check col" style="margin-left: -8.5rem;">
                    ...
                    <div class="col-md-3 table-responsive" id="ORINA" style="margin-top: -16rem">
                        <b>ORINA</b>
                        <div class="form-check">
                    ...
                    <div class="row">
                        <div class="col-md-3 table-responsive" id="ENZIMAS">
                            <b>ENZIMAS</b>
                            <div class="row">
                        ...
                        <div class="col-md-6 table-responsive" id="INFECCIOSAS" style="margin-top: -1.5rem;">
                            ...
                            <div class="row">
                                ...
                                <div class="form-check col" style="margin-left: 8rem;">
                        ...
                        <div class="col-md-3 table-responsive" id="HECES" style="margin-top: -31.5rem;">
                            <b>HECES</b>
                            <div class="form-check">
                        ...
                        <div class="row">
                            <div class="col-md-3 table-responsive" id="DROGAS">
                                <b>DROGAS</b>
                                <div class="form-check">
                            ...
                            <div class="col-md-6 table-responsive" id="OTROS">
                                <b>OTROS</b>
                                <div class="form-check">
                            ...
                            <div class="col-md-3 table-responsive" id="FIRMA" style="margin-top: -25rem;">
                                <asp:TextBox ID="TextBox20" CssClass="border-bottom border-dark" Style="border: none; width:100%" runat="server"></asp:TextBox>
                                <br />
                                <asp:Label class="form-check-label" align="center" for="Muestra" runat="server" Text="MEDICO"></asp:Label>
                            </div>
                        </div>
                    </div>
                </div>
