    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <div class="container" style="background-color: white; font-family:Arial">
                    ...
                    <div class="list-group list-group-flush">
                        <asp:Table class="table table-bordered table-light text-center" runat="server">
                            <asp:TableRow>
                                ...
                                <asp:TableCell Text="ESTABLECIMIENTO DE SALUD" Style="width: 350px; background-color: #cdfecc; font-size: 15px"></asp:TableCell>
                                <asp:TableCell Text="NÚMERO DE HISTORIA CLÍNICA" Style="width: 350px; background-color: #cdfecc; font-size: 15px"></asp:TableCell>
                                <asp:TableCell Text="NÚMERO DE ARCHIVO" Style="width: 350px; background-color: #cdfecc; font-size: 15px"></asp:TableCell>
                            </asp:TableRow>
                            <asp:TableRow>
                                <asp:TableCell>
                        ...
                        <asp:Table class="table table-bordered table-light table-responsive text-center" runat="server">
                            <asp:TableRow>
                                <asp:TableCell Text="PRIMER APELLIDO" Style="width: 165px; background-color: #cdfecc; font-size: 15px"></asp:TableCell>
                                <asp:TableCell Text="SEGUNDO APELLIDO" Style="width: 175px; background-color: #cdfecc; font-size: 15px"></asp:TableCell>
                                <asp:TableCell Text="PRIMER NOMBRE" Style="width: 165px; background-color: #cdfecc; font-size: 15px"></asp:TableCell>
                                <asp:TableCell Text="SEGUNDO NOMBRE" Style="width: 175px; background-color: #cdfecc; font-size: 15px"></asp:TableCell>
                                <asp:TableCell Text="SEXO" Style="width: 50px; background-color: #cdfecc; font-size: 15px"></asp:TableCell>
                                <asp:TableCell Text="EDAD (AÑOS)" Style="width: 50px; background-color: #cdfecc; font-size: 15px"></asp:TableCell>
                                <asp:TableCell Text="PUESTO DE TRABAJO (CIUO)" Style="width: 150px; background-color: #cdfecc; font-size: 15px"></asp:TableCell>
                                <asp:TableCell Text="FECHA DEL ÚLTIMO DÍA LABORAL" Style="width: 125px; background-color: #cdfecc; font-size: 15px"></asp:TableCell>
                                <asp:TableCell Text="FECHA DE REINGRESO" Style="width: 100px; background-color: #cdfecc; font-size: 15px"></asp:TableCell>
                                <asp:TableCell Text="TOTAL (DÍAS)" Style="width: 50px; background-color: #cdfecc; font-size: 15px"></asp:TableCell>
                                <asp:TableCell Text="CAUSA DE SALIDA" Style="width: 165px; background-color: #cdfecc; font-size: 15px"></asp:TableCell>
                            </asp:TableRow>
                            <asp:TableRow>
                                <asp:TableCell>
                ...
                <br />
                <div class="card" style="width: auto;">
                    <div class="card-header" style="background-color: #cccdfe; font-size:15px">
                        C. ENFERMEDAD ACTUAL
                    </div>
                    <div class="list-group list-group-flush">
                ...
                <div class="card" style="width: auto;">
                    ...
                    <div class="list-group list-group-flush">
                        <asp:Table class="table table-bordered table-light text-center" runat="server">
                            <asp:TableRow>
                                <asp:TableCell Text="REGIONES" Style="width: 100%; text-align: left; background-color: #ccffff; font-size:15px" ColumnSpan="15"></asp:TableCell>
                            </asp:TableRow>
                            <asp:TableRow>
                            ...
                            <asp:TableRow>
                                ...
                                <asp:TableCell RowSpan="4" style="background-color: #ccffff; font-size:15px">
                                    <asp:Label CssClass="REI-COLUMN" ID="Label22" runat="server" Text="13. #ccffff"></asp:Label>
                                </asp:TableCell>
                            ...
                            <asp:TableRow>
                                <asp:TableCell Style="text-align: left; background-color: white; font-size:12px" ColumnSpan="6">CP = CON EVIDENCIA DE PATOLOGÍA:  MARCAR "X" Y DESCRIBIR EN LA SIGUIENTE SECCIÓN</asp:TableCell>
                                <asp:TableCell Style="text-align: left; background-color: white; font-size:12px" ColumnSpan="6">SP = SIN EVIDENCIA DE PATOLOGÍA:  MARCAR "X" Y NO DESCRIBIR</asp:TableCell>
                ...
                <div class="card" style="width: auto;">
                    ...
                    <div class="list-group list-group-flush">
                        <asp:Table class="table table-bordered table-light table-responsive text-center" runat="server">
                            <asp:TableRow>
                                <asp:TableCell Style="width: 30px; background-color: #cdfecc; font-size:15px"></asp:TableCell>
                                <asp:TableCell Style="width: 800px; text-align: end; background-color: #cdfecc; font-size:15px">PRE= PRESUNTIVO          DEF= DEFINITIVO</asp:TableCell>
                                <asp:TableCell Style="width: 200px; background-color: #cdfecc; font-size:15px">CIE</asp:TableCell>
                                <asp:TableCell Style="width: 75px; background-color: #cdfecc; font-size:15px">PRE</asp:TableCell>
                                <asp:TableCell Style="width: 75px; background-color: #cdfecc; font-size:15px">DEF</asp:TableCell>
                            </asp:TableRow>
                            <asp:TableRow>
                ...
                <div class="card" style="width: auto;">
                    ...
                    <div class="list-group list-group-flush">
                        <asp:Table class="table table-bordered table-light text-center" runat="server">
                            ...
                            <asp:TableRow>
                                <asp:TableCell style="background-color: #ccffff; font-size: 15px">Reubicación</asp:TableCell>
                                <asp:TableCell ColumnSpan="7">
