            ...
            <div class="container" style="background-color: white">
                ...
                <div class="card" style="width: auto;">
                    ...
                    <div class="list-group list-group-flush">
                        ...
                        <asp:Table class="table table-bordered table-light text-center" runat="server">
                            <asp:TableRow>
                                <asp:TableCell Text="PRIMER APELLIDO" Style="width: 250px; background-color: #34495E; color: white; font-size: 16px"></asp:TableCell>
                                <asp:TableCell Text="SEGUNDO APELLIDO" Style="width: 250px; background-color: #34495E; color: white; font-size: 16px"></asp:TableCell>
                                <asp:TableCell Text="PRIMER NOMBRE" Style="width: 250px; background-color: #34495E; color: white; font-size: 16px"></asp:TableCell>
                                <asp:TableCell Text="SEGUNDO NOMBRE" Style="width: 250px; background-color: #34495E; color: white; font-size: 16px"></asp:TableCell>
                                <asp:TableCell Text="SEXO" Style="width: 50px; background-color: #34495E; color: white; font-size: 16px"></asp:TableCell>
                                <asp:TableCell Text="PUESTO DE TRABAJO (CIUO)" Style="width: 250px; background-color: #34495E; color: white; font-size: 16px"></asp:TableCell>
                            </asp:TableRow>
                            <asp:TableRow>
                                <asp:TableCell>
                ...
                <div class="card" style="width: auto;">
                    ...
                    <asp:Table class="table table-bordered table-light table-responsive text-center" runat="server">
                        <asp:TableRow>
                            <asp:TableCell Style="width: 300px; background-color: #34495E; color: white; font-size: 16px">CONSUMOS NOCIVOS</asp:TableCell>
                            ...
                            <asp:TableCell Style="width: 200px; background-color: #34495E; color: white; font-size: 16px">TIEMPO DE CONSUMO</asp:TableCell>
                            <asp:TableCell Style="width: 250px; background-color: #34495E; color: white; font-size: 16px">CANTIDAD</asp:TableCell>
                            <asp:TableCell Style="width: 200px; background-color: #34495E; color: white; font-size: 16px">EX CONSUMIDOR</asp:TableCell>
                            <asp:TableCell Style="width: 200px; background-color: #34495E; color: white; font-size: 16px">TIEMPO DE ABSTINENCIA</asp:TableCell>
                        </asp:TableRow>
                        <asp:TableRow>
                    ...
                    <asp:Table class="table table-bordered table-light table-responsive text-center" runat="server">
                        <asp:TableRow>
                            <asp:TableCell Style="width: 300px; background-color: #34495E; color: white; font-size: 16px">ESTILO</asp:TableCell>
                            <asp:TableCell Style="width: 75px; background-color: #34495E; color: white; font-size: 16px">SI</asp:TableCell>
                            <asp:TableCell Style="width: 75px; background-color: #34495E; color: white; font-size: 16px">NO</asp:TableCell>
                            <asp:TableCell Style="width: 550px; background-color: #34495E; color: white; font-size: 16px">¿CUÁL?</asp:TableCell>
                            <asp:TableCell Style="width: 300px; background-color: #34495E; color: white; font-size: 16px">TIEMPO/CANTIDAD</asp:TableCell>
                        </asp:TableRow>
                        <asp:TableRow>
                ...
                <div class="card" style="width: auto;">
                    <div class="row">
                        ...
                        <div class="card-header col" style="text-align: right; margin-right: 0.8rem; background-color: #34495E; color: white; font-size: 16px">
                ...
                <div class="card" style="width: auto;">
                    ...
                    <asp:Table class="table table-bordered table-light table-responsive text-center" runat="server">
                        <asp:TableRow>
                            <asp:TableCell Style="width: 200px; background-color: #34495E; color: white; font-size: 16px" RowSpan="2" ColumnSpan="2">PUESTO DE TRABAJO / ÁREA</asp:TableCell>
                            <asp:TableCell Style="width: 200px; background-color: #34495E; color: white; font-size: 16px" RowSpan="2">ACTIVIDADES</asp:TableCell>
                            <asp:TableCell Style="width: 200px; background-color: #34495E; color: white; font-size: 16px" RowSpan="2">TIEMPO DE TRABAJO (MESES)</asp:TableCell>
                            <asp:TableCell Style="width: 250px; background-color: #34495E; color: white; font-size: 16px" ColumnSpan="10">FÍSICO</asp:TableCell>
                            <asp:TableCell Style="width: 400px; background-color: #34495E; color: white; font-size: 16px" ColumnSpan="15">MECÁNICO</asp:TableCell>
                        </asp:TableRow>
                        <asp:TableRow>
                    ...
                    <asp:Table class="table table-bordered table-light table-responsive text-center" runat="server">
                        <asp:TableRow>
                            ...
                            <asp:TableCell Style="width: 200px; background-color: #34495E; color: white; font-size: 16px" RowSpan="2">ACTIVIDADES</asp:TableCell>
                            <asp:TableCell Style="width: 200px; background-color: #34495E; color: white; font-size: 16px" RowSpan="2">TIEMPO DE TRABAJO (MESES)</asp:TableCell>
                            <asp:TableCell Style="width: 250px; background-color: #34495E; color: white; font-size: 16px" ColumnSpan="9">QUÍMICO</asp:TableCell>
                            <asp:TableCell Style="width: 200px; background-color: #34495E; color: white; font-size: 16px" ColumnSpan="7">BIÓLOGO</asp:TableCell>
                            <asp:TableCell Style="width: 250px; background-color: #34495E; color: white; font-size: 16px" ColumnSpan="5">ERGONÓMICO</asp:TableCell>
                        </asp:TableRow>
                        <asp:TableRow>
                            <asp:TableCell Style="background-color: #34495E; color: white; font-size: 16px">
                    ...
                    <asp:Table class="table table-bordered table-light table-responsive text-center" runat="server">
                        <asp:TableRow>
                            <asp:TableCell Style="width: 150px; background-color: #34495E; color: white; font-size: 16px" ColumnSpan="13">PSICOSOCIAL</asp:TableCell>
                            <asp:TableCell Style="width: 500px; background-color: #34495E; color: white; font-size: 16px" RowSpan="2">MEDIDAS PREVENTIVAS</asp:TableCell>
                        </asp:TableRow>
                        <asp:TableRow>
                            <asp:TableCell Style="background-color: #34495E; color: white; font-size: 16px">
                ...
                <div class="card" style="width: auto;">
                    ...
                    <div class="list-group list-group-flush">
                        <asp:Table class="table table-bordered table-light table-responsive text-center" runat="server">
                            <asp:TableRow>
                                <asp:TableCell Text="PRESIÓN ARTERIAL (mmHg)" Style="width: 175px; background-color: #34495E; color: white; font-size: 16px"></asp:TableCell>
                                <asp:TableCell Text="TEMPERATURA (°C)" Style="width: 175px; background-color: #34495E; color: white; font-size: 16px"></asp:TableCell>
                                <asp:TableCell Text="FRECUENCIA CARDIACA (Lat/min)" Style="width: 175px; background-color: #34495E; color: white; font-size: 16px"></asp:TableCell>
                                <asp:TableCell Text="SATURACIÓN DE OXÍGENO (O2%)" Style="width: 175px; background-color: #34495E; color: white; font-size: 16px"></asp:TableCell>
                                <asp:TableCell Text="FRECUENCIA RESPIRATORIA (fr/min)" Style="width: 175px; background-color: #34495E; color: white; font-size: 16px"></asp:TableCell>
                                <asp:TableCell Text="PESO (Kg)" Style="width: 175px; background-color: #34495E; color: white; font-size: 16px"></asp:TableCell>
                                <asp:TableCell Text="TALLA (cm)" Style="width: 175px; background-color: #34495E; color: white; font-size: 16px"></asp:TableCell>
                                <asp:TableCell Text="ÍNDICE DE MASA CORPORAL (kg/m2)" Style="width: 175px; background-color: #34495E; color: white; font-size: 16px"></asp:TableCell>
                                <asp:TableCell Text="PERÍMETRO ABDOMINAL(cm)" Style="width: 175px; background-color: #34495E; color: white; font-size: 16px"></asp:TableCell>
                            </asp:TableRow>
                            <asp:TableRow>
                                <asp:TableCell>
                                        <asp:TextBox runat="server" BorderStyle="None" style="background-color:transparent; width:100%; text-align:center"></asp:TextBox>
                ...
                <div class="card" style="width: auto;">
                    ...
                    <div class="list-group list-group-flush">
                        <asp:Table class="table table-bordered table-light text-center" runat="server">
                            <asp:TableRow>
                                <asp:TableCell Text="REGIONES" Style="width: 100%; background-color: #34495E; color: white; font-size: 16px; text-align: left" ColumnSpan="15"></asp:TableCell>
                            </asp:TableRow>
                            <asp:TableRow>
                            ...
                            <asp:TableRow>
                                <asp:TableCell ColumnSpan="12" Style="text-align: left; background-color: #34495E; color: white; font-size: 16px">SI EXISTE EVIDENCIA DE PATOLOGÍA MARCAR CON "X" Y DESCRIBIR EN LA SIGUIENTE SECCIÓN COLOCANDO EL NUMERAL</asp:TableCell>
                ...
                <div class="card" style="width: auto;">
                    ...
                    <div class="list-group list-group-flush">
                        <asp:Table class="table table-bordered table-light table-responsive text-center" runat="server">
                            <asp:TableRow>
                                <asp:TableCell Style="width: 950px; text-align: end; background-color: #34495E; color: white; font-size: 16px" ColumnSpan="2">PRE= PRESUNTIVO          DEF= DEFINITIVO</asp:TableCell>
