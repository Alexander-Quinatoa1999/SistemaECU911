            ...
            <div class="container" style="background-color: white">
                ...
                <div class="card" style="width: auto;">
                    ...
                    <div class="list-group list-group-flush">
                        ...
                        <asp:Table class="table table-bordered table-light text-center" runat="server">
                            <asp:TableRow>
                                <asp:TableCell Text="PRIMER APELLIDO" Style="width: 225px; background-color: #34495E; color: white; font-size:16px"></asp:TableCell>
                                <asp:TableCell Text="SEGUNDO APELLIDO" Style="width: 225px; background-color: #34495E; color: white; font-size:16px"></asp:TableCell>
                                <asp:TableCell Text="PRIMER NOMBRE" Style="width: 225px; background-color: #34495E; color: white; font-size:16px"></asp:TableCell>
                                <asp:TableCell Text="SEGUNDO NOMBRE" Style="width: 225px; background-color: #34495E; color: white; font-size:16px"></asp:TableCell>
                                <asp:TableCell Text="SEXO" Style="width: 100px; background-color: #34495E; color: white; font-size:16px"></asp:TableCell>
                ...
                <div class="card" style="width: auto;">
                    ...
                    <div class="list-group list-group-flush">
                        <asp:Table class="table table-bordered table-light table-responsive text-center" runat="server">
                            <asp:TableRow>
                                <asp:TableCell Text="FECHA DE EMISIÓN:" Style="width: 350px; background-color: #34495E; color: white; font-size:16px"></asp:TableCell>
                            ...
                            <asp:TableRow>
                                <asp:TableCell Text="EVALUACIÓN:" Style="width: 350px; background-color: #34495E; color: white; font-size:16px"></asp:TableCell>
                                <asp:TableCell Text="INGRESO" Style="width: 250px; background-color: #34495E; color: white; font-size:16px"></asp:TableCell>
                                ...
                                <asp:TableCell Text="PERIÓDICO" Style="width: 150px; background-color: #34495E; color: white; font-size:16px"></asp:TableCell>
                                <asp:TableCell Style="width: 75px">
                                ...
                                <asp:TableCell Text="REINTEGRO" Style="width: 150px; background-color: #34495E; color: white; font-size:16px"></asp:TableCell>
                                <asp:TableCell Style="width: 75px">
                                ...
                                <asp:TableCell Text="RETIRO" Style="width: 150px; background-color: #34495E; color: white; font-size:16px"></asp:TableCell>
                                <asp:TableCell Style="width: 75px">
                ...
                <div class="card" style="width: auto;">
                    ...
                    <div class="list-group list-group-flush">
                        <asp:Table class="table table-bordered table-light text-center" runat="server">
                            <asp:TableRow>
                                <asp:TableCell Text="Después de la valoración médica ocupacional se certifica que la persona en mención, es calificada como:" Style="width: 1160px; text-align: left; background-color: #34495E; color: white; font-size:16px" ColumnSpan="8"></asp:TableCell>
                            </asp:TableRow>
                            <asp:TableRow>
                ...
                <div class="card" style="width: auto;">
                    ...
                    <div class="list-group list-group-flush">
                        <asp:Table class="table table-bordered table-light text-center" runat="server">
                            <asp:TableRow>
                                <asp:TableCell Text="El usuario se realizó la evaluación médica de retiro" Style="width: 705px; text-align: left; background-color: #34495E; color: white; font-size:16px"></asp:TableCell>
                                <asp:TableCell Text="SI" Style="width: 100px; background-color: #34495E; color: white; font-size:16px"></asp:TableCell>
                                ...
                                <asp:TableCell Text="NO" Style="width: 100px; background-color: #34495E; color: white; font-size:16px"></asp:TableCell>
                                <asp:TableCell Style="width: 50px">
                            ...
                            <asp:TableRow>
                                <asp:TableCell Text="Condición del diagnóstico" Style="width: 705px; text-align: left; background-color: #34495E; color: white; font-size:16px"></asp:TableCell>
                                <asp:TableCell Text="Presuntiva" Style="width: 50px; background-color: #34495E; color: white; font-size:16px"></asp:TableCell>
                                <asp:TableCell Style="width: 50px">
                                ...
                                <asp:TableCell Text="Definitiva" Style="width: 100px; background-color: #34495E; color: white; font-size:16px"></asp:TableCell>
                                <asp:TableCell Style="width: 50px">
                                ...
                                <asp:TableCell Text="No aplica" Style="width: 100px; background-color: #34495E; color: white; font-size:16px"></asp:TableCell>
                                <asp:TableCell Style="width: 50px">
                            ...
                            <asp:TableRow>
                                <asp:TableCell Text="La condición de salud esta relacionada con el trabajo" Style="width: 705px; text-align: left; background-color: #34495E; color: white; font-size:16px"></asp:TableCell>
                                <asp:TableCell Text="SI" Style="width: 100px; background-color: #34495E; color: white; font-size:16px"></asp:TableCell>
                                <asp:TableCell Style="width: 50px">
